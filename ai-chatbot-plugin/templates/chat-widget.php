...
$custom_text = get_option('ai_chatbot_custom_text', array('online_status' => 'В сети'));
?>
    ...
    <div class="ai-chatbot-window">
        ...
        <div class="ai-chatbot-header">
            ...
            <div class="ai-chatbot-info">
                ...
                <div class="ai-chatbot-status"><?php echo esc_html($custom_text['online_status'] ?? 'В сети'); ?></div>
            </div>
